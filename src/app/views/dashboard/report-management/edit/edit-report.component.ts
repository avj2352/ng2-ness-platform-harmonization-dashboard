...
@Component({selector: 'phd-edit-report', templateUrl: './edit-report.component.html', styleUrls: ['./edit-report.component.scss']})
export class EditReportComponent implements OnInit {
    ...
    constructor(private staticDataService : StaticDataService, private activateRoute : ActivatedRoute, private reportManagementService : ReportManagementService, private router : Router, private logInService : LoginService) {
        this
            .activateRoute
            .params
            .subscribe(params => {
    ...
    updateReportAction(obj) {
        ...
        for (var i = 0; i < this.checkboxSelectedItems.length; i++) {
            checkboxSelectedItemsList.push({id: this.checkboxSelectedItems[i], active: 1})
        }
        ...
        this
            ...
            .subscribe((response) => {
                if (response.status && response.status == 401) {
                    ...
                    this
                        .router
                        .navigateByUrl('/dashboard/' + envConfig.routerURL.Report_Management + '/list');
                }
